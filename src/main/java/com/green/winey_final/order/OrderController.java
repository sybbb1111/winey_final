...
public class OrderController {
    ...
    public List<SelOrderVo>  selOrder(Long userId){
    ...
    public DetailVo selOrderDetail(@RequestParam Long orderId, @RequestParam Long usrId) {
        return service.selOrderDetail(orderId,usrId);
    }
